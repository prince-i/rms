    ...
    <div class="col">
      <div class="card">
           <div class="card-header" style="background-color: #88A0B9;">
            ...
            <div>
              <!-- Material unchecked -->
              <div class="form-check" style="margin-left: 21.3%;margin-top: 1%;width:220px;">
                <select name="year" id="year" class=" column browser-default custom-select" disabled onchange="filter()">
...
<!--  <div class="divSearch"> -->
 ...
 <!-- LOADER END -->
 <div class="divSearch" style="overflow-y: scroll;height: 450px;margin-top: -63px;margin-left: -14px;width: 102%;display:none;">
 <table id="table1" class="table table-bordered "  style="table-layout:fixed;word-wrap: break-word;">
<?php
   $sql = "SELECT control_number from tbl_manpowerrequest WHERE control_number like '$year%' ";
   $query = $db->query($sql);
...
const filter =()=>{
  year = $("#year").val();
  window.location = "manpowerRequestDataSummary.php?year="+year;
}
</script>
<?php
